    ...
    <section id="about" className="section bg-gradient-to-b from-background to-secondary/20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <FadeIn className="order-2 lg:order-1">
          ...
          <a href="#programs" className="primary-btn inline-block">
        ...
        <FadeIn direction="left" className="order-1 lg:order-2">
          <div className="relative">
            <div className="aspect-square rounded-2xl bg-gradient-to-tr from-primary/20 to-primary/5 overflow-hidden glass-card">
            ...
            <div className="absolute -bottom-6 -right-6 w-40 h-40 rounded-xl bg-primary/10 -z-10"></div>
            <div className="absolute -top-6 -left-6 w-24 h-24 rounded-xl bg-primary/10 -z-10"></div>
          </div>
        </FadeIn>
      </div>
    </section>
